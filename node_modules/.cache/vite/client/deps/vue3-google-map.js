...
var ze = P({
  ...
  emits: me,
  setup(n3, { emit: e }) {
    const t = y(), s = y(false), r = y(), o = y(), i = y(false);
    U(B, r), U(Z, o), U(Ae, i);
    const l = () => {
      const c = { ...n3 };
...
function He(n3, e, t, s, r, o) {
  return Y(), X("div", null, [
    ae("div", Ge, null, 512),
    Q(n3.$slots, "default", Ne(Ue({ ready: n3.ready, map: n3.map, api: n3.api, mapTilesLoaded: n3.mapTilesLoaded })), void 0, true)
  ]);
}
...
var Pt = P({
  ...
  setup(n3, { emit: e, expose: t, slots: s }) {
    const r = $(n3, "options"), o = $(n3, "pinOptions"), i = y(), l = b(B, y()), a = b(Z, y()), d = b(ce, y()), u = H(
...
var V = (n3, e, t, s) => {
  ...
  return x(
    ...
    (d, [u, c]) => {
      ...
      !o.value || !i.value || !h || (r.value ? (r.value.setOptions(t.value), a.value && ((p = l.value) == null || p.removeMarker(r.value), (m = l.value) == null || m.addMarker(r.value))) : (Je(n3) ? r.value = S(
...
var xt = P({
  ...
  emits: ve,
  setup(n3, { emit: e, expose: t, slots: s }) {
    const r = $(n3, "options"), o = V("Marker", ve, r, e);
...
var Xe = P({
  ...
  setup(n3, { emit: e }) {
    const t = y(null), s = b(B, y()), r = b(Z, y()), o = b(Ae, y(false)), i = x(
      [o, r, t],
      ([d, u, c]) => {
...
function et(n3, e, t, s, r, o) {
  return Y(), X("div", Qe, [
    Q(n3.$slots, "default", {}, void 0, true)
  ], 512);
}
...
function rt(n3, e, t, s, r, o) {
  return n3.hasSlotContent ? (Y(), X("div", st, [
    ae("div", Le({ ref: "infoWindowRef" }, n3.$attrs), [
      Q(n3.$slots, "default", {}, void 0, true)
    ], 16)
  ])) : Se("", true);
}
...
function Ct(n3, e, t, s, r, o) {
  return n3.hasSlotContent ? (Y(), X("div", kt, [
    ae("div", Le({
      ref: "customMarkerRef",
